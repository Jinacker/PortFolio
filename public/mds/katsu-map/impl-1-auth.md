...
| **검증** | 전환 기간을 포함한 6개월 이상의 운영 로그에서 인증 전환에 기인한 장애가 관측되지 않음 |
...
전환 기간을 포함해 6개월 이상 운영하는 동안, **운영 로그와 모니터링 기준으로 인증 전환에 기인한 장애는 관측되지 않았습니다.** 구버전과 신버전이 같은 응답 계약을 유지한 채 인증 방식을 바꾼 결과입니다.
