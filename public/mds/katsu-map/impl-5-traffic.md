...
![돈가스 지도 관리자 대시보드 — 시간대별 방문 분포, 점심·저녁 식사 시간에 방문이 몰리는 패턴](/assets/experiences/katsu-map/admin-dashboard-traffic.png)
...
- 가장 붐비는 저녁시간(18~19시)과 가장 한산한 새벽의 방문 수는 **10배 이상** 차이 납니다.
...
정리하면 저녁 피크에 수십 명이 비슷한 시점에 앱을 열면 **짧은 구간에 수백 건의 요청이 집중될 수 있는 구조**입니다.
