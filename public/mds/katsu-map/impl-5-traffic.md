...
실제로 푸시 발송 직후 사용자가 한꺼번에 복귀하면서 Rate limit에 걸린 사례가 있었습니다. 이후 **푸시 발송 자체를 시간축으로 분산**했고, 자세한 과정은 「푸시 발송 직후 몰리던 요청을 분산해 오류를 줄였습니다」에서 별도로 다룹니다.
