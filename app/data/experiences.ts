      ...
      detailSections: [
        {
          title: "끼니톡은 어떤 서비스인가",
          items: [
            "혼자 사시는 어르신의 식사 불균형·복약 누락·건강 이상을 가족이 제때 알아차리기 어렵다",
            "끼니톡은 어르신 앱과 보호자 앱을 연결해 식사·복약·건강 상태를 자연스럽게 공유하는 서비스다",
            "기존 건강관리 서비스처럼 직접 검색하고 기록하는 대신, 사진 한 장과 말 한마디만으로 정보를 남길 수 있도록 AI가 입력 과정을 대신한다",
            "어르신은 쉽게 사용하고, 가족은 멀리서도 자연스럽게 확인할 수 있게 하는 것이 끼니톡의 핵심이다",
          ],
          highlights: [
            "식사 불균형·복약 누락·건강 이상을 가족이 제때 알아차리기 어렵다",
            "어르신 앱과 보호자 앱을 연결해 식사·복약·건강 상태를 자연스럽게 공유하는 서비스",
            "사진 한 장과 말 한마디만으로 정보를 남길 수 있도록 AI가 입력 과정을 대신한다",
        ...
        },
        {
          title: "아키텍처",
          items: [
            "백엔드 서버(NestJS)와 분리된 무상태 AI 서버(FastAPI) — 자원 프로필과 상태 보유가 정반대라 확장·프라이버시·책임 경계를 위해 분리",
            "외부 AI(GPT-4o-mini Vision, 벤더 챗 엔진)는 어댑터·정규화 계층 뒤에 격리",
          ],
          highlights: [
            "무상태 AI 서버(FastAPI)",
            "확장·프라이버시·책임 경계",
          ...
          docs: [
            { href: "/mds/kkinitalk/architecture.md", label: "전체 아키텍처 — AI 서버를 분리한 이유" },
          ],
        },
        {
          title: "무슨 일을 맡았나",
        ...
        },
        {
          ...
          items: [],
          docs: [
            { href: "/mds/kkinitalk/impl-pipeline.md", label: "식단 분석 파이프라인 — 모델을 갈아끼워도 살아남는 구조" },
            { href: "/mds/kkinitalk/impl-inference-ops.md", label: "추론 서버 운영 설계 — 느린 것이 죽은 것으로 오판되지 않게" },
            { href: "/mds/kkinitalk/impl-llm-layer.md", label: "LLM 연동 계층 — 비결정적 출력을 계약으로 묶기" },
            { href: "/mds/kkinitalk/impl-ssrf.md", label: "이미지 보안 — URL 입력이 만든 SSRF 공격 표면 방어" },
            { href: "/mds/kkinitalk/impl-chatbot.md", label: "외부 챗봇 연동 — 남이 만든 AI를 우리 얼굴로 내보내기" },
          ],
        },
        {
          title: "AI 모델 검증",
          items: [],
          docs: [
            { href: "/mds/kkinitalk/verify-property.md", label: "값 대신 성질을 단언한다 — 비결정 시스템 검증 설계" },
            { href: "/mds/kkinitalk/verify-emergency.md", label: "적대적 입력이 찾은 응급 결함 — recall 45.8% → 100%" },
            { href: "/mds/kkinitalk/verify-vision.md", label: "Vision 일관성 측정 — 같은 사진 5회에 5가지 답" },
            { href: "/mds/kkinitalk/verify-load.md", label: "부하·동시성 검증 — 코드에만 있던 안전장치 증명" },
          ],
        },
        {
          title: "트러블슈팅",
          items: [],
          docs: [
            { href: "/mds/kkinitalk/ts-cost.md", label: "GPT Vision 건당 비용 12배 절감 (8.08원 → 0.68원)" },
            { href: "/mds/kkinitalk/ts-label.md", label: "한식이 전부 \"영양 미등록\" — 라벨 공간과의 싸움" },
            { href: "/mds/kkinitalk/ts-stt.md", label: "벤더 STT 실패 — 두 번의 실험으로 원인 진단" },
            { href: "/mds/kkinitalk/ts-guard-gap.md", label: "커버리지 100%의 응급 가드가 음성 경로에서 뚫렸다" },
            { href: "/mds/kkinitalk/ts-fake-ai.md", label: "운영에 가짜 AI가 나갔다 — 전부 초록불이었다" },
          ],
        },
        {
          title: "경험을 통해 배운 점",
