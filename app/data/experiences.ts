      ...
      detailSections: [
        {
          ...
          items: [
            "군 복무를 마치고 돌아오니 세상이 꽤 달라져 있었습니다. GPT라는 도구가 계산과 코딩, 리서치를 몇 초 만에 도와주는 모습이 신기했고, 처음에는 정말 많은 일을 대신해 줄 수 있겠다고 생각했습니다.",
        ...
        },
        {
          ...
          extra: {
            items: [
              "전처리 전략을 바꿀 때마다 정확도가 조금씩 오르는 과정이 너무 재미있었습니다. 밤새 실험하고 교수님께 자문을 구할 만큼 몰입하면서, 막연했던 호기심이 AI를 본격적으로 공부해 보고 싶다는 마음으로 바뀌었습니다.",
            ],
            highlights: [
              "정확도가 조금씩 오르는 과정",
              "밤새 실험",
        ...
        },
        {
          ...
          extra: {
            items: [
              "자연어처리 수업에서는 언어모델이 발전해 온 과정과 Transformer, GPT를 거쳐 오늘날의 LLM으로 이어지는 원리를 배웠습니다. 수업에서 익힌 내용을 바탕으로 LLaMA 3.2에 직접 적용해보며, LoRA·Few-shot Prompt·Reasoning SFT 등 서로 다른 방법이 모델의 결과에 어떤 차이를 만드는지 비교하고 실험했습니다.",
            ],
            highlights: [
