    ...
    },
    {
      ...
      detailSections: [
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              ...
              ["AI 검증 체계", "계약·AI 출력 검증 · 성능 측정 · 부하 테스트 하네스"],
        ...
        },
        {
          ...
          title: "AI 결과와 운영 안전장치를 실제 입력과 부하로 검증했습니다",
          items: [
            "같은 입력에도 답변이 달라질 수 있는 AI는 특정 문장을 비교하는 대신, 반드시 지켜야 할 응답 구조와 안전 기준을 확인했습니다.",
            "외부 챗봇은 19개 항목으로 인수 검증했고, 응급 안내는 실제 STT 응답이 포함된 정답 세트로, 서버의 동시 실행 제한과 타임아웃은 고정 지연을 넣은 부하 시나리오로 검증했습니다.",
          ],
          highlights: [
            "반드시 지켜야 할 응답 구조와 안전 기준",
            "19개 항목으로 인수 검증",
            "실제 STT 응답이 포함된 정답 세트",
            "고정 지연을 넣은 부하 시나리오",
          ],
          layout: "paragraphs",
          docs: [
