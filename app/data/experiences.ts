      ...
      detailSections: [
        {
          ...
          items: [
            ...
            "대표·기획·프론트엔드·백엔드 각 1명으로 구성된 4인 팀에서 백엔드 개발을 담당했습니다. 서비스에 필요한 API와 데이터 구조를 설계·구현하고 프론트엔드와 연동했으며, 작은 팀인 만큼 개발에만 머무르지 않고 기획 단계부터 기능의 우선순위와 구현에 필요한 시간·비용까지 함께 고민했습니다.",
        ...
        },
        {
          title: "아이디어를 실제 사업으로",
          items: [
            "서비스의 사업화 가능성을 인정받아 중앙대학교 캠퍼스타운 입주기업으로 선정되었고, 실제 사무실에 입주해 개발을 이어갔습니다. 또한 사업화 지원금 900만 원을 확보하며 아이디어를 실제 사업으로 발전시키는 과정을 경험했습니다.",
          ],
          highlights: [
        ...
        },
        {
          title: "이 경험을 통해 배운 것",
          items: [
            "트래드랩은 제가 처음으로 개발을 넘어 사업이 어떻게 움직이는지 가까이에서 경험한 팀이었습니다.",
            ...
            "특히 안정적인 직장을 떠나 자신이 믿는 사업에 온전히 뛰어든 대표님의 모습을 가까이에서 보며, 자신의 선택에 책임을 지고 몰입하는 태도에 대해서도 많이 배웠습니다.",
            "이후 다른 회사에서 인턴으로 근무하며 제 진로와 우선순위가 점차 명확해졌고, 트래드랩에 예전만큼 온전히 몰입하기 어렵다고 판단했습니다. 애매하게 자리를 유지하기보다 백엔드 후임자를 구하고 인수인계를 마친 뒤 팀을 정리했습니다.",
            "개발뿐 아니라 사업, 시간과 비용, 그리고 함께 일하는 방식을 처음 제대로 배울 수 있었던 소중한 경험이었습니다.",
            "언젠가 트래드랩이 크게 성장해서 대표님이 정말 돈방석에 앉으셨으면 좋겠습니다.",
          ],
          highlights: [
            "개발을 넘어 사업이 어떻게 움직이는지 가까이에서 경험한 팀",
            "얼마의 시간과 비용이 필요한지, 그만한 가치가 있는지, 그리고 그 선택을 팀원들과 어떻게 조율하고 설득할지",
            "제품 개발은 제한된 시간과 자원 안에서 선택하는 과정",
            "자신의 선택에 책임을 지고 몰입하는 태도",
            "백엔드 후임자를 구하고 인수인계를 마친 뒤 팀을 정리했습니다.",
