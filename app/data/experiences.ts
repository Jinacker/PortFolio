      ...
      detailSections: [
        {
          title: "끼니톡은 어떤 서비스인가",
          items: [
            "혼자 사시는 어르신의 식사·복약·건강 상태를 멀리 있는 가족이 함께 챙기는 서비스",
            "기존 기록 앱은 어르신에게 입력을 시킨다 — 어르신이 못 쓰면 아무것도 수집되지 않는다",
            "그래서 AI가 입력 부담을 대신 진다 — 식사는 사진 한 장(Vision 분석), 건강 상태는 말 한마디(음성 상담), 복약은 알림 확인만",
            "어르신 조작을 사진 한 장과 말 한마디로 줄이는 것이 이 서비스에서 AI의 존재 이유",
          ],
          highlights: [
            "혼자 사시는 어르신",
            "식사·복약·건강 상태",
            "가족이 함께",
            "어르신이 못 쓰면 아무것도 수집되지 않는다",
            "AI가 입력 부담을 대신",
            "사진 한 장",
            "말 한마디",
            "AI의 존재 이유",
        ...
        },
        {
          title: "무슨 일을 맡았나",
          items: [
            "팀 프로젝트에서 AI 쪽 전부를 담당 — 일반 도메인(인증·식사·복약 CRUD)은 다른 팀원 담당",
            "AI 서버 전체 — 식단 사진 분석 파이프라인(FastAPI) 설계·구현, LLM 연동, 무상태 운영 설계, SSRF 보안",
            "외부 LLM 챗봇 연동 — 벤더 건강상담 엔진 연동 계층, 응급 가드레일, 음성(STT/TTS)",
            "AI 관련 앱 화면 — 음성 건강대화 화면, 녹음·무음 감지 UX",
            "AI 검증 체계 — 불변식·메타모픽·적대적 입력 등 비결정적 시스템의 검증 설계",
            "규모 — AI 서버 약 2,400줄 · pytest 105 passed(키·GPU 없이) · 계약 하네스 37 · 챗봇 Jest 377 passed · 설계 문서 15편",
          ],
          highlights: [
            "AI 쪽 전부",
            "AI 서버 전체",
            "식단 사진 분석 파이프라인(FastAPI)",
            "무상태 운영 설계",
            "SSRF 보안",
            "외부 LLM 챗봇 연동",
            "응급 가드레일",
