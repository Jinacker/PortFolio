      ...
      detailSections: [
        {
          ...
          items: [
            "슈어소프트테크는 자동차처럼 오류가 곧 사고로 이어지는 소프트웨어를 검증하는 국내 대표 V&V 전문 기업",
            "소속 팀은 자동차 SW의 국제 인증 심사(ASPICE) 준비를 돕는 플랫폼 V-SPICE를 개발",
            "AI 엔진(ALIRA)이 C 코드를 분석해 설계 문서와 다이어그램을 자동으로 만들어주는, 실제 고객사가 쓰는 제품",
            "Spring Boot + JSP + Vue2 + PostgreSQL 기반, 5년간 쌓인 레거시 코드베이스 위에서의 개발",
          ],
          highlights: [
            "오류가 곧 사고로 이어지는 소프트웨어",
            "ASPICE",
            "V-SPICE",
            "AI 엔진(ALIRA)",
            "실제 고객사가 쓰는 제품",
        ...
        },
        {
          ...
          pdf: {
            ...
            label: "팀 성과 발표 자료로 보는 V-SPICE와 내 작업의 위치",
            sections: [
        ...
        },
        {
          title: "무슨 일을 맡았나",
          items: [
            "16주 동안 풀스택 개발 인턴으로 근무 — 연습용 과제가 아니라 실제 제품에 들어가는 기능을 담당",
            "API 설계 → 구현 → 성능 최적화 → QA → 인수인계까지 개발의 전체 사이클을 직접 경험",
            "회의에서 나온 아이디어를 스스로 과제로 만들어 제품 기능까지 완성하는 방식으로 일함",
          ],
          highlights: [
            "16주",
            "풀스택 개발 인턴",
