    ...
    },
    {
      ...
      detailSections: [
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              ...
              ["건강 챗봇 연동", "API 검증 · 벤더 연동 · 동의 처리 · 응급 가드레일 · STT/TTS · 음성 대화 화면"],
        ...
        },
        {
          title: "트러블슈팅",
          items: [
            "테스트만으로 발견하지 못한 문제들을 실제 앱과 배포 환경에서 직접 찾아 해결했습니다.",
            "문제를 고치는 데서 끝내지 않고, 같은 문제가 다시 발생하지 않도록 검증 과정 자체를 개선했습니다.",
          ],
          highlights: [
            "실제 앱과 배포 환경에서 직접 찾아 해결",
            "같은 문제가 다시 발생하지 않도록 검증 과정 자체를 개선",
          ],
          layout: "paragraphs",
          docs: [
