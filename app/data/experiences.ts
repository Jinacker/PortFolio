  ...
  ko: [
    {
      ...
      detailSections: [
        ...
        },
        {
          title: "경험을 통해 배운 점",
          items: [
            "\"필드 하나 추가\"의 진짜 비용은 코드가 아니라 기존 사용자와 데이터에 대한 판단이라는 것",
            "모니터링 신호는 교차 검증 전까지 사실이 아니라는 것 — 없는 장애를 만들 뻔한 504가 가르쳐 줬다",
            "최적화는 성능만 바꾸는 게 아니라 지표의 의미를 바꿀 수 있다는 것 — DAU 정의가 바뀐 걸 위험으로 기록했다",
            "실사용자가 있는 서비스는 실패한 시도까지 기록해야 한다는 것 — 기록이 다음 결정을 빠르게 만든다",
          ],
          highlights: [
            "기존 사용자와 데이터에 대한 판단",
            "교차 검증 전까지 사실이 아니라는 것",
            "지표의 의미를 바꿀 수 있다는 것",
            "실패한 시도까지 기록",
          ],
        },
