...
const passionGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      ["2024.09 ~ 2024.11", "2024 데이터 크리에이터 캠프 스타터 과정", "", "https://blog.naver.com/rlawls1448/223672382935"],
    ],
  },
  {
    title: "개인 수상 및 장학금",
  ...
  },
  {
    ...
    items: [
      ...
      ["2024.12.05 ~ 2025.03.21", "KT 대학생 IT 서포터즈 KIT 2기 - 기획팀 부팀장", "KT희망나눔그룹", "https://blog.naver.com/rlawls1448/223815131854"],
      ["2024.08.17 ~ 2024.09.21", "부천시 스마트리빙랩 시민참여단 팀장", "부천시", "https://blog.naver.com/rlawls1448/223554607352"],
      ["2024.08.12 ~ 2024.10.31", "디지털 혁신 페스타 서포터즈 1기", "지디넷코리아", "https://blog.naver.com/rlawls1448/223672365443"],
    ],
  },
]
...
export default function NewPortfolioPage() {
  useEffect(() => {
    ...
    // 대표 경험 딥링크(#experience-101, #experience-101-card 등)로 들어온 경우에는 해시를 지우지 않는다.
