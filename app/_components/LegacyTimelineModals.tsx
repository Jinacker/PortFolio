...
type LegacyTimelineModalsProps = {
  activeModal: string | null;
  closeModal: () => void;
};

export default function LegacyTimelineModals({ activeModal, closeModal }: LegacyTimelineModalsProps) {
  ...
  return createPortal(
    <>
      <style jsx global>{`
        ...
        .legacy-timeline-modal li {
          display: list-item !important;
          padding-left: 0.35rem;
        }

        .legacy-timeline-modal li > div.rounded-full:first-child {
          display: none !important;
        }

        .legacy-timeline-modal li > p {
          display: inline;
          margin: 0;
        }
      `}</style>
      ...
      {activeModal === 'issueOne' && (
        <div
          className="legacy-timeline-modal fixed inset-0 bg-black bg-opacity-50 z-[1000] flex items-center justify-center p-4"
          onClick={() => closeModal()}
        >
          <div
            ...
            <div className="p-8">
              ...
              <div className="mb-12">
                ...
                <ul className="space-y-2">
                  <li className="grid items-start" style={{ gridTemplateColumns: "6px minmax(0, 1fr)", columnGap: "1rem" }}>
              ...
              <div className="mb-12">
                ...
                <div className="mb-6">
                  ...
                  <ul className="space-y-2 ml-4">
                    ...
                    <li className="ml-4 grid items-start" style={{ gridTemplateColumns: "6px minmax(0, 1fr)", columnGap: "1rem" }}>
